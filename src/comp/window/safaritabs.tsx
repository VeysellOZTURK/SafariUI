      ...
      {list.map((tab) => (
        <div
          ...
          className={isSelected === tab.id ? ' cursor-pointer bg-[#334155] select-none text-slate-900 font-medium px-4 py-1.5 flex items-center justify-center space-x-2 dark:text-slate-200'
            : 'cursor-pointer bg-slate-100 text-slate-400 rounded-tl border border-slate-900/5 pl-4 pr-8 py-1.5 -mb-px -mr-4 flex items-center justify-center space-x-2 dark:bg-slate-800 dark:text-slate-500'}
        >
